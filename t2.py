...
def build_model():
    ...
    top_model.load_weights('D:/flower_top_FC_model')
...
model_checkpoint = ModelCheckpoint('flow.h5', monitor='loss', save_best_only=True)
